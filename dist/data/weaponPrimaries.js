...
var WEAPON_PRIMARY = require('../constants.js').ITEM_TYPE.WEAPON_PRIMARY;
...
var _require$PRIMARY_CATE = require('../constants.js').PRIMARY_CATEGORIES,
    BOW = _require$PRIMARY_CATE.BOW,
    LAUNCHER = _require$PRIMARY_CATE.LAUNCHER,
    RIFLE = _require$PRIMARY_CATE.RIFLE,
    SHOTGUN = _require$PRIMARY_CATE.SHOTGUN,
    SNIPER = _require$PRIMARY_CATE.SNIPER,
    SPEARGUN = _require$PRIMARY_CATE.SPEARGUN;

var DREKAR_TROOPERS = ENEMY.DREKAR_TROOPERS,
    HEAVY_GUNNERS = ENEMY.HEAVY_GUNNERS,
...
var BARO_KITEER = LOCATION.BARO_KITEER,
    CEPHALON_SIMARIS = LOCATION.CEPHALON_SIMARIS,
...
var ANNIVERSARY = REWARD.ANNIVERSARY,
    ...
    RAZORBACK_ARMADA = REWARD.RAZORBACK_ARMADA,
...
module.exports = weaponPrimaries.map(function (object) {
  return _extends({}, object, { type: WEAPON_PRIMARY });
});