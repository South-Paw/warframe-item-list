...
module.exports = {
  warframes: [
    ...
    { name: 'Ember Prime', acquisition: RELICS },
    { name: 'Equinox', acquisition: TYL_REGOR },
    { name: 'Excalibur', acquisition: LECH_KRILL },
    { name: 'Excalibur Prime', acquisition: UNOBTAINABLE },
    { name: 'Frost', acquisition: VOR_AND_KRILL },
    { name: 'Frost Prime', acquisition: RELICS },
    ...
    { name: 'Loki Prime', acquisition: RELICS },
    ...
    { name: 'Trinity', acquisition: AMBULAS },
